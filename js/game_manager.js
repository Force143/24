...
GameManager.prototype.addRandomTile = function () {
  if (this.grid.cellsAvailable()) {
    var value = Math.random() < 0.999999 ? Math.random() < 0.99998 ? Math.random() < 0.99995 ? Math.random() < 0.998 ? Math.random() < 0.9333333333333333333 ? Math.random() < 0.8 ? 1 : Math.random() < 0.875 ? 2 : Math.random() < 0.9 ? 4 : 8 : Math.random() < 0.9 ? 3 : Math.random() < 0.95 ? 6 : 12 : 50 : 80 : 90 : 99;
